 function [Signal_comp]=init_bin(measurement_duration_min, num_electrode)
...
hdr_files           = dir(fullfile(bin_dir, '*.hdr')); % Get all binaries files in folder
...
if nb_bin >= 1
    for i=1:nb_bin
        ...
        [Signal] = binshort2signal(fpath,measurement_duration_ms, num_electrode, conv_factor);
